...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__generator_probe_finder_gp_input_gp_input_component__ = __webpack_require__("../../../../../src/app/generator-probe-finder/gp-input/gp-input.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__generator_probe_finder_gp_input_diameter_gp_input_diameter_component__ = __webpack_require__("../../../../../src/app/generator-probe-finder/gp-input-diameter/gp-input-diameter.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__generator_probe_finder_product_view_product_view_component__ = __webpack_require__("../../../../../src/app/generator-probe-finder/product-view/product-view.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__generator_probe_finder_extra_filters_extra_filters_component__ = __webpack_require__("../../../../../src/app/generator-probe-finder/extra-filters/extra-filters.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__generator_probe_finder_product_view_product_product_component__ = __webpack_require__("../../../../../src/app/generator-probe-finder/product-view/product/product.component.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_15__generator_probe_finder_gp_input_gp_input_component__["a" /* GpInputComponent */],
            __WEBPACK_IMPORTED_MODULE_16__generator_probe_finder_gp_input_diameter_gp_input_diameter_component__["a" /* GpInputDiameterComponent */],
            __WEBPACK_IMPORTED_MODULE_17__generator_probe_finder_product_view_product_view_component__["a" /* ProductViewComponent */],
            __WEBPACK_IMPORTED_MODULE_18__generator_probe_finder_extra_filters_extra_filters_component__["a" /* ExtraFiltersComponent */],
            __WEBPACK_IMPORTED_MODULE_19__generator_probe_finder_product_view_product_product_component__["a" /* ProductComponent */]
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_20_ngx_bootstrap__["a" /* AlertModule */].forRoot(),
            __WEBPACK_IMPORTED_MODULE_14__angular_router__["a" /* RouterModule */].forRoot([
                {
                    path: 'accessories',
                    component: __WEBPACK_IMPORTED_MODULE_8__product_accessories_finder_accessories_accessories_component__["a" /* AccessoriesComponent */]
                },
                {
                    path: 'gp-finder',
...
module.exports = "<section *ngIf=\"showFilters\">\n  <hr>\n  <form class=\"Filtered-inputs\">\n    <div *ngFor=\"let selecter of selecterArray\" class=\"form-check form-check-inline\">\n      <label class=\"form-check-label\">\n        <input class=\"form-check-input\" type=\"radio\" name=\"filter-radio\" (click)=\"onClick(selecter)\" [checked]=\"isChecked\" value=\"{{selecter}}\"> {{selecter}}\n      </label>\n    </div>\n    <div *ngIf=\"windowState\" class=\"filter window-filter\">\n      <div class=\"close-btn\"><i class=\"glyphicon glyphicon-remove\" (click)=\"closeFilter()\"></i></div>\n      <ng-template ngFor let-window [ngForOf]=\"windowList\">\n        <button class=\"list-group-item list-group-item-action\" (click)=\"filterClick('window_size', window)\" [ngClass]=\"{ 'filterActive': filterActive === window}\"><span>{{window}}</span></button>\n      </ng-template>\n    </div>\n    <div *ngIf=\"typeState\" class=\"filter type-filter\">\n      <div class=\"close-btn\"><i class=\"glyphicon glyphicon-remove\" (click)=\"closeFilter()\"></i></div>\n      <ng-template ngFor let-type [ngForOf]=\"typeList\">\n        <button class=\"list-group-item list-group-item-action\" (click)=\"filterClick('type', type)\" [ngClass]=\"{ 'filterActive': filterActive === type}\"><span>{{type}}</span></button>\n      </ng-template>\n    </div>\n    <div *ngIf=\"lengthState\" class=\"filter length-filter\">\n      <div class=\"close-btn\"><i class=\"glyphicon glyphicon-remove\" (click)=\"closeFilter()\"></i></div>\n      <ng-template ngFor let-length [ngForOf]=\"lengthList\">\n        <button class=\"list-group-item list-group-item-action\" (click)=\"filterClick('length', length)\" [ngClass]=\"{ 'filterActive': filterActive === length}\"><span>{{length}}</span></button>\n      </ng-template>\n    </div>\n  </form>\n</section>\n\n\n"
...
var ExtraFiltersComponent = (function () {
    function ExtraFiltersComponent(_service, data) {
        ...
        this.data.showfilter.subscribe(function (value) {
            _this.showFilters = value;
        });
        this.data.fState.subscribe(function (state) { return _this.filterState = state; });
        this.data.selectedProduct.subscribe(function (product) {
            _this.removeFilters();
        });
        this.data.prodList.subscribe(function (products) {
            if (_this.filterState) {
                _this.removeFilters();
                _this.filteredList = products;
            }
    ...
    ExtraFiltersComponent.prototype.filterClick = function (type, value) {
...
ExtraFiltersComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_gprobe_ui_gprobe_ui_service__["a" /* GprobeUiService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_gprobe_ui_gprobe_ui_service__["a" /* GprobeUiService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_data_data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_data_data_service__["a" /* DataService */]) === "function" && _b || Object])
...
var GpInputDiameterComponent = (function () {
    ...
    GpInputDiameterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.selectedProduct.subscribe(function (product) {
            _this.selectedValue = product;
            _this.data.hideFilter(false);
            _this.processingRange('');
            _this.diameterArray = [];
            _this.selectedDiameter = 'Select a Diameter';
            if (_this.masterProductList !== undefined) {
                _this.masterProductList.forEach(function (item) {
                    if (item.master === _this.selectedValue) {
                        item.related.forEach(function (prod) {
                            _this.diameterArray.push(prod.diameter);
                        });
                    }
                });
                _this.diameterArray = __WEBPACK_IMPORTED_MODULE_3_underscore__["uniq"](_this.diameterArray);
                _this.show = true;
            }
        });
    };
...
], GpInputDiameterComponent.prototype, "masterProductList", void 0);
...
], GpInputComponent.prototype, "masterProductList", void 0);
...
var GpUiComponent = (function () {
    function GpUiComponent(_service) {
        this._service = _service;
        this.catName = 'Generator Probes';
        this.loading = false;
        this.getProducts();
...
GpUiComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_gprobe_ui_gprobe_ui_service__["a" /* GprobeUiService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_gprobe_ui_gprobe_ui_service__["a" /* GprobeUiService */]) === "function" && _a || Object])
], GpUiComponent);
...
var ProductViewComponent = (function () {
    function ProductViewComponent(_service, data) {
        ...
        this.getProducts1 = function () {
            ...
            var selectProdArr = [];
            var coco = [];
            this.masterProductList.forEach(function (item) {
        ...
        this.data.diameter.subscribe(function (diameter) {
            if (_this.masterProductList !== undefined) {
                if (diameter !== 'Select Diameter' && diameter !== '') {
                    _this.diameterSelected = diameter;
                    _this.products = _this.getProducts1();
                    _this.showProducts = true;
                    _this.data.productListChanged(_this.products);
                }
            }
        });
    ...
    ProductViewComponent.prototype.addToCart = function (product) {
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", Object)
], ProductViewComponent.prototype, "masterProductList", void 0);
...
var AccessoriesComponent = (function () {
    ...
    AccessoriesComponent.prototype.addToCart = function (product) {
        this.data.changCart(product);
    };
    ...
    AccessoriesComponent.prototype.changeCat = function (value) {
    ...
    AccessoriesComponent.prototype.listProducts = function (cat) {
        ...
        if (!flag) {
            this.showSubCat = false;
            this.products = __WEBPACK_IMPORTED_MODULE_4_underscore__["uniq"](prodList).reverse();
            this.toggleState();
        }
        else {
            this.showSubCat = true;
            this.subProducts = __WEBPACK_IMPORTED_MODULE_4_underscore__["uniq"](prodList).reverse();
        }
    };
    ...
    AccessoriesComponent.prototype.getCatgegories = function (masterProduct) {
        ...
        this.categories = __WEBPACK_IMPORTED_MODULE_4_underscore__["sortBy"](catList);
        this.categories.splice(0, 0, 'Select a Category');
    };
    AccessoriesComponent.prototype.bannerExist = function () {
...
var DataService = (function () {
    function DataService() {
        ...
        this.selectedInput = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["BehaviorSubject"]([]);
        this.selectedProduct = this.selectedInput.asObservable();
        this.selectedDiameter = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["BehaviorSubject"]([]);
        this.diameter = this.selectedDiameter.asObservable();
    }
    ...
    DataService.prototype.productSelected = function (product) {
        this.selectedInput.next(product);
    };
    DataService.prototype.diameterChanged = function (diameter) {
...
var GprobeUiService = (function () {
        ...
        this.checking = function (productsArr, names) {
            ...
            names.forEach(function (product) {
                ...
                productsArr.forEach(function (prod) {
                    if (__WEBPACK_IMPORTED_MODULE_3_underscore__["contains"](product.related_products, prod.id) && prod.cat_name === 'Generator Probes') {
                        obj.related.push(prod);
                    }
                });
                relatedProducts.push(obj);
            });
            console.log('sorted array: ', __WEBPACK_IMPORTED_MODULE_3_underscore__["sortBy"](relatedProducts, 'master'));
            return __WEBPACK_IMPORTED_MODULE_3_underscore__["sortBy"](relatedProducts, 'master');
        };
    }
    GprobeUiService.prototype.getGeneratprobes = function (cat) {
        ...
        return this.http
            ...
            var catList = (function (a) {
                for (var i = productArray.length; i--;) {
                    if (__WEBPACK_IMPORTED_MODULE_3_underscore__["intersection"](productArray[i].related_products, generators).length > 0) {
